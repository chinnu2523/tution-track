...
def seed_courses():
    ...
    courses = [
        ...
        {"id": "vms", "title": "VMS Edutech", "category": "tec", "level": "Professional", "description": "Professional Edutech Courses", "icon": "🏢", "color": "#ff4d4d", "skills": ["Course Management","Student Tracking","Fee Automation","Result Processing"]}
    ]
    db = get_db()
